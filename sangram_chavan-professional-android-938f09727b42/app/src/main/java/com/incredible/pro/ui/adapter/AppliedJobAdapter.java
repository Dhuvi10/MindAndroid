...
import com.incredible.pro.DTO.AppliedJobDTO;
...
import com.incredible.pro.ui.fragment.AppliedJobsFrag;
...
public class AppliedJobAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holderMain, final int position) {
        if (holderMain instanceof MyViewHolder) {
            ...
            holder.ivDelete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ProjectUtils.showDialog(mContext, mContext.getResources().getString(R.string.delete), mContext.getResources().getString(R.string.delete_msg), new DialogInterface.OnClickListener() {
                        @Override
    ...
    public void delete(int pos) {
        ...
        paramsDelete.put(Consts.AJ_ID, appliedJobDTOSList.get(pos).getAj_id());
        ProjectUtils.showProgressDialog(mContext, true, mContext.getResources().getString(R.string.please_wait));
        new HttpsRequest(Consts.DELETE_APPLIED_JOB_API, paramsDelete, mContext).stringPost(TAG, new Helper() {
            @Override
            public void backResponse(boolean flag, String msg, JSONObject response) {
