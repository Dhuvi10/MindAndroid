...
import com.incredible.pro.ui.adapter.AppliedJobAdapter;
...
public class AppliedJobsFrag extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void showData() {
        appliedJobAdapter = new AppliedJobAdapter(AppliedJobsFrag.this, appliedJobDTOSListSection, userDTO, myInflater);
