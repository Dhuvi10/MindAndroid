package com.incredible.pro.interfacess;
...
public interface Consts {
    String APP_NAME = "Incredible";
    //old 677440
    String BASE_URL = "https://incredibles.pro/controls/Webservice/";
    String PAYMENT_FAIL = "https://incredibles.pro/controls/Stripe/Payment/fail";
    String PAYMENT_SUCCESS = "https://incredibles.pro/controls/Stripe/Payment/success";
    String MAKE_PAYMENT = "https://incredibles.pro/controls/Stripe/Payment/make_payment/";

    String PAYMENT_FAIL_Paypal = "https://incredibles.pro/controls/Webservice/payufailure";
    String PAYMENT_SUCCESS_paypal = "https://incredibles.pro/controls/Webservice/payusuccess";
    String MAKE_PAYMENT_paypal = "https://incredibles.pro/controls/Webservice/paypalWallent?";
    String PRIVACY_URL = "https://incredibles.pro/controls/Webservice/privacy";
    String TERMS_URL = "https://incredibles.pro/controls/Webservice/term";
    ...
    String DELETE_BOOKING_API = "deletebooking";
    String DELETE_APPLIED_JOB_API = "deleteAppliedJob";
    ...
    static final String DEVELOPER_KEY = "AIzaSyDyK4jTH-qp1lCHlp5V5FNmpyPPnN2PSso";
